<template>
  <div id="activity-cost">
    <header-vue
      :name="$route.query.typeName"
      :isDelete="type == 'edit'"
      @delClick="delClick"
      @goPrev="goPrev"
    ></header-vue>
...
<script>
  ...
  addressData.forEach(province => {
    ...
    // province.children.forEach(city => {   city.children = areaList[city.value];
    // });
  });
  ...
  export default {
    ...
    methods: {
      ...
      save(i) {
        ...
        // this.$refs.descriptionValue.focus();   return; }

        let arg = [
          {
            // bigBillItemTypeName: null, billId: 3664,
            id:
