<template>
  <li class="use-chapter-item" @click="handleClick(data.id)">
    <div class="main">
      <h2>
        {{ data.fullName }} 提交的盖章审批
      ...
      <ul>
        ...
        <li><span>盖章时间</span>{{ data.useTime ? data.useTime : "--" }}</li>
        <li>
          <span>盖章事由</span><i>{{ data.note ? data.note : "--" }}</i>
        </li>
      </ul>
